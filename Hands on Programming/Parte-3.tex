...
\urlstyle{same}
\hypersetup{
  pdftitle={Parte: Slot Machine},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Parte: Slot Machine}
\author{}
\date{\vspace{-2.5em}}
...
\hypertarget{capuxectulo-3-programs}{%
\subsection{\texorpdfstring{\textbf{Capìtulo 3:}
Programs}{Capìtulo 3: Programs}}\label{capuxectulo-3-programs}}

El siguiente còdigo genera tres sìmbolos comunes en este tipo de juegos:
diamonds (DD), sevens (7), triple bars (BBB), double bars (BB), single
bars (B), cherries (C), and zeroes (0) Los sìmbolos son sleccionados
aleatoriamente y cada simbolo aparece con diferentes probabilidades
