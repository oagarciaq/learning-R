...
Es realizar todo lo contrario a lo anterior. Pasar datos de las filas a columnas

```{r}
cms_patient_experience
```

A continuación se puede observar que en realidad solo hay 6 datos distintos
...
ejemplo de funcionaiento más sencillo sería:
...
A partir de este punto se trabajará el código a través de un proyecto (Aunque probablemente tome apuntes en este lugar para llevar un buen control)
